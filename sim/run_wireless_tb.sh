...
W=sim/nvc_work
nvc --work=work:$W -a --relaxed rtl/proc_bus_gba.vhd rtl/reggba_serial.vhd rtl/gba_serial.vhd rtl/gba_wireless.vhd rtl/gba_wireless_uart.vhd sim/tb_wireless.vhd
