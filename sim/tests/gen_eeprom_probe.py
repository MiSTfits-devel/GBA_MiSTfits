...
src = os.path.join(here, "eeprom_probe.s")
obj = os.path.join(here, "eeprom_probe.o")
out = os.path.join(here, "eeprom_probe.gba")
...
code[0xA0:0xAC] = b"EEPROMPROB\0\0"
code[0xAC:0xB0] = b"AEEP"
code[0xB0:0xB2] = b"01"
code[0xB2] = 0x96
chk = 0
